...
SVGLine ← (
  +⊥2⇡4¤"x1"
  /$"_ _"≡$"_=\"_\""
  $"<line _ stroke=\"black\" ></line>"
)
SVGPoint ← (
  °⊟
  $"<circle cx=\"_\" cy=\"_\" r=\"5\"></circle>"
)
RenderToSVG ← (
  ⊜(□⊜⋕⊸≠@,)⊸≠@\n
  ⊃(⍜÷₁₀⌈+10≡/↥⍉↯∞_2/(⊂°□⊙°□)
  ...
  map [] []
  insert □"xmlns" □"http://www.w3.org/2000/svg"
...
SVGPoint ← (
  °⊟
  $"<circle cx=\"_\" cy=\"_\" r=\"1\" stroke-width=\"0.25\" fill=\"orange\" stroke=\"black\"></circle>"
)
RenderToSVG ← (
  # ⊜(□⊜⋕⊸≠@,)⊸≠@\n
  ⊃(⍜÷₁₀⌈+10≡/↥⍉↯∞_2/(⊂°□⊙°□)
